...
public class FileInputStream_3 {
	public static void main(String[] args) throws IOException {
		...
		String str = new String(byteArray2, 0, offset + coutn2, Charset.defaultCharset());
		System.out.println(str);
		is3.close();
		Logitech mx keys mini for that what i wanted best keys Can you feel my heart beat?
	}
                              shk}
