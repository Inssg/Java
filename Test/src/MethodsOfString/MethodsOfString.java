...
public class MethodsOfString {
	public static void main(String[] args) {
		...
		System.out.println(str2.length()); // 한영 구분없이 한 문자당 1개의크기 가짐
		System.out.println();
		// 문자열 검색
		// @charAt()
		System.out.println(str1.charAt(1));
		System.out.println(str2.charAt(1)); // 한영 구분없이 인덱스 1위치의 문자
		System.out.println();
		
		//@indexOf(), lastIndexOf()
		System.out.println(str1.indexOf('a'));  //앞에서부터 첫 번째 'a'가 위치한 인덱스
		System.out.println(str1.lastIndexOf('a')); //뒤에서부터 첫 번째 'a'가 위치한 인덱스
		System.out.println(str1.indexOf('a', 8)); // 8d은 검색 시작위치
